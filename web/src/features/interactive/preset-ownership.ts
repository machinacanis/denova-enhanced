export type PresetResourceKind = 'teller' | 'event' | 'rule' | 'opening' | 'director' | 'image'
...
export const GAME_ONLY_PRESET_RESOURCE_KINDS: PresetResourceKind[] = ['director', 'event', 'rule', 'opening']
