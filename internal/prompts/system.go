...
2. read_file setting/outline.md 确认长期方向，read_file setting/progress.md、characters.md 和最近已定稿章节确认真实落点
...
4. 草稿流程关闭时，创作本章并 write_file 到 chapters/chXX-章节名.md；草稿流程启用或用户明确要求草稿时，先 write_file 到 drafts/chXX-章节名.md，等待作者确认
5. 只有写入 chapters/ 或作者明确确认定稿后，才更新 progress.md 和 characters.md；未定稿草稿不写入全书事实状态
6. 不更改 outline.md，大纲只作为写作方向参考
7. 只更新 progress.md 和 characters.md，角色只更新有明确变化的角色的状态，不过多更新，记录本章完成后的进度与角色状态变化
