...
func (s *Server) registerRoutes(h *hertzserver.Hertz) {
	...
	api := h.Group("/api")
	{
		...
		api.POST("/interactive/stories/:id/director/events/:event_id/force", apiHandlers.HandleInteractiveDirectorEventForce)
		api.POST("/interactive/stories/:id/director/events/:event_id/disable", apiHandlers.HandleInteractiveDirectorEventDisable)
		...
		api.GET("/event-systems", apiHandlers.HandleEventSystems)
		api.POST("/event-systems", apiHandlers.HandleEventSystemCreate)
		api.GET("/event-systems/:id", apiHandlers.HandleEventSystem)
		api.PATCH("/event-systems/:id", apiHandlers.HandleEventSystemUpdate)
		api.DELETE("/event-systems/:id", apiHandlers.HandleEventSystemDelete)
